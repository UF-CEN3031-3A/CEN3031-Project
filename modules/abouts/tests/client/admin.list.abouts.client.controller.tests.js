(function () {
  ...
  describe('Admin Abouts List Controller Tests', function () {
    // Initialize global variables
    var AboutsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _AboutsService_) {
      ...
      $httpBackend.whenGET('/modules/abouts/client/views/list-abouts.client.view.html').respond(200, '');
      ...
      AboutsAdminListController = $controller('AboutsAdminListController as vm', {
        $scope: $scope
      });
