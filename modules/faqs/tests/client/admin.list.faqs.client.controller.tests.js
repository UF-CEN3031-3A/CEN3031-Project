(function () {
  ...
  describe('Admin Faqs List Controller Tests', function () {
    // Initialize global variables
    var FaqsAdminListController,
      $scope,
      $httpBackend,
      $state,
      Authentication,
    ...
    beforeEach(inject(function ($controller, $rootScope, _$state_, _$httpBackend_, _Authentication_, _FaqsService_) {
      ...
      $httpBackend.whenGET('/modules/faqs/client/views/list-faqs.client.view.html').respond(200, '');
      ...
      FaqsAdminListController = $controller('FaqsAdminListController as vm', {
        $scope: $scope
      });
